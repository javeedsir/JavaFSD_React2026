...
import com.hexaware.validations.exceptions.StudentNotFoundException;
...
public class StudentRestController {
	 ...
	 public   Student   getBySid(@PathVariable  long sid) throws StudentNotFoundException {
		 
		 
				Student student = service.getBySid(sid);
